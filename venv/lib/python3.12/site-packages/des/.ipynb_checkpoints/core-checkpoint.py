...
def encode_block(block, derived_keys, encryption, firstBlock):
    ...
    for i, key in enumerate(derived_keys):
        ...
        if i == 0 and firstBlock:
            print("======================")
            print(f"This is the first encoded block")
            b_left = format(block[0], '08b')
            print('\n'.join([b_left[i:i+8] for i in range(0, len(b_left), 8)]))
            b_right = format(block[1], '08b')
            print('\n'.join([b_right[i:i+8] for i in range(0, len(b_right), 8)]))
            print("======================")
            print("Round keys:")
            print(derived_keys)
            print("======================")
